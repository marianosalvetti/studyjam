package net.msalvetti.android.appasynckapplication;
...
public class ABTest extends AppCompatActivity  implements HiddenFragment.TaskCallbacks {
     ...
     */
         ...
         */
            Intent i = getIntent();
            position = i.getIntExtra(MainActivity.SEND_KEY_VALUE, -1);
